    ...
    <section ref={sectionRef} className="py-8 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Kategori Layanan</h2>
          ...
          <Link
            ...
            className="self-start px-4 py-2 bg-slate-100 rounded-full text-sm cursor-pointer hover:bg-slate-200 transition whitespace-nowrap"
          >
            Semua Layanan →
          </Link>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="bg-white p-4 rounded-lg flex items-center justify-center h-40">
                  <img src={item.image} className="w-full max-w-64 h-24 object-contain" />
                </div>
