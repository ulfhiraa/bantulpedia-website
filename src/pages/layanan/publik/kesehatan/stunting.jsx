  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <div className="max-w-7xl mx-auto w-full px-4 md:px-8 lg:px-12 -mt-10 md:-mt-12 relative z-20 pb-20">
        ...
        {/* --- SUMMARY CARDS --- */}
        <div className="bg-emerald-100/80 border border-emerald-200 rounded-lg py-3 px-4 text-center mb-8 shadow-sm"><h2 className="text-emerald-800 text-lg md:text-xl font-medium">Hasil Pengukuran dan Penimbangan Balita</h2></div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="bg-teal-100 rounded-xl p-6 text-center shadow-sm border border-teal-200 flex flex-col items-center justify-center h-40"><div className="text-4xl font-bold text-slate-800 mb-2">48.345</div><div className="text-sm font-medium text-slate-600">Jumlah Balita</div></div>
            <div className="bg-teal-100 rounded-xl p-6 text-center shadow-sm border border-teal-200 flex flex-col items-center justify-center h-40"><div className="text-4xl font-bold text-slate-800 mb-2">41.518</div><div className="text-sm font-medium text-slate-600 px-4">Jumlah Balita yang di ukur & Ditimbang</div></div>
            <div className="bg-teal-100 rounded-xl p-6 text-center shadow-sm border border-teal-200 flex flex-col items-center justify-center h-40"><div className="text-4xl font-bold text-slate-800 mb-2">86,04%</div><div className="text-sm font-medium text-slate-600 px-4">Persentase Balita yang di ukur & Ditimbang</div></div>
        </div>
